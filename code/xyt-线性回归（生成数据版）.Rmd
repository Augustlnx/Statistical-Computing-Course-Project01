...
generate_data <- function(n) {
  ...
  x3=rnorm(n)
  x4=rnorm(n)
  y=5.9-0.5*x1+0.18*x2 +35.4*x3+ 5.8*x4+rnorm(n, sd = 1)#生成因变量
  return(data.frame(y, x1,x2,x3,x4))
}
true_beta=c(5.9,-0.5,0.18,35.4,5.8)
set.seed(42)
B=n
K=1000
...
for(j in 1:K){
  ...
  mse_boot11[j]=(boot1[j]-true_beta[1])^2
  mse_boot21[j]=(boot2[j]-true_beta[2])^2
  mse_boot31[j]=(boot3[j]-true_beta[3])^2
  mse_boot41[j]=(boot4[j]-true_beta[4])^2
  mse_boot51[j]=(boot5[j]-true_beta[5])^2
  #Jackknife的估计
   ...
   mse_jack11[j]=(jack1[j]-true_beta[1])^2
   mse_jack21[j]=(jack2[j]-true_beta[2])^2
   mse_jack31[j]=(jack3[j]-true_beta[3])^2
   mse_jack41[j]=(jack4[j]-true_beta[4])^2
   mse_jack51[j]=(jack5[j]-true_beta[5])^2
}
 #保存参数结果
 ...
 #Bootstrap的BIAS
  bias_boot1 <- calculate_bias(mean(boot1), true_beta[1] )
  bias_boot2<- calculate_bias(mean(boot2), true_beta[2] )
  bias_boot3 <- calculate_bias(mean(boot3), true_beta[3] )
  bias_boot4 <- calculate_bias(mean(boot4,na.rm=TRUE), true_beta[4] )
  bias_boot5 <- calculate_bias(mean(boot5,na.rm=TRUE), true_beta[5] )
  bias_data <- rbind(bias_data, data.frame(SampleSize = n, Method = "Bootstrap",  Intercept = bias_boot1, X1 = bias_boot2, X2 = bias_boot3, X3 = bias_boot4,X4 = bias_boot5)) 
   #Jackknife的偏差
   bias_jack1 <- calculate_bias(mean(jack1),  true_beta[1])
   bias_jack2 <- calculate_bias(mean(jack2),  true_beta[2])
   bias_jack3 <- calculate_bias(mean(jack3),  true_beta[3])
   bias_jack4 <- calculate_bias(mean(jack4,na.rm=TRUE), true_beta[4])
   bias_jack5 <- calculate_bias(mean(jack5,na.rm=TRUE), true_beta[5])
...
ggplot(results1, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[1], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of intercept, n=20",
       x = "Estimate",
       y = "Density") +
...
ggplot(results2, aes(x = Estimate, fill = Method)) +
  geom_density(alpha = 0.5) +
  geom_vline(xintercept = true_beta[2], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x1,n=20",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results3, aes(x = Estimate, fill = Method)) +
  geom_density(alpha = 0.5) +
  geom_vline(xintercept = true_beta[3], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x2,   n=20",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results4, aes(x = Estimate, fill = Method)) +
  geom_density(alpha = 0.5) +
  geom_vline(xintercept = true_beta[4], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x3,   n=20",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results5, aes(x = Estimate, fill = Method)) +
  geom_density(alpha = 0.5) +
  geom_vline(xintercept = true_beta[5], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x4,  n=20",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
for(j in 1:K){
  ...
  boot4[j]=boot_results[4]
  boot5[j]=boot_results[5]
  mse_boot12[j]=(boot1[j]-true_beta[1])^2
  mse_boot22[j]=(boot2[j]-true_beta[2])^2
  mse_boot32[j]=(boot3[j]-true_beta[3])^2
  mse_boot42[j]=(boot4[j]-true_beta[4])^2
  mse_boot52[j]=(boot5[j]-true_beta[5])^2
  #Jackknife的估计
   jack_results <- jackknife_regression(sample_data, n)
   jack1[j]=jack_results[1]
   jack2[j]=jack_results[2]
   ...
   jack4[j]=jack_results[4]
   jack5[j]=jack_results[5]
   mse_jack12[j]=(jack1[j]-true_beta[1])^2
   mse_jack22[j]=(jack2[j]-true_beta[2])^2
   mse_jack32[j]=(jack3[j]-true_beta[3])^2
   mse_jack42[j]=(jack4[j]-true_beta[4])^2
   mse_jack52[j]=(jack5[j]-true_beta[5])^2
}
 #保存参数结果
 results <- rbind(results, data.frame(SampleSize = n, Method = "Bootstrap",Intercept =mean(boot1),X1=mean(boot2),X2=mean(boot3),X3=mean(boot4,na.rm=TRUE),X4=mean(boot5)))
...
ggplot(results1, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[1], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of intercept, n=30",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results2, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[2], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x1, n=30",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results3, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[3], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x2, n=30",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results4, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[4], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x3,  n=30",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results5, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[5], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x4,  n=30",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
for(j in 1:K){
  ...
  boot4[j]=boot_results[4]
  boot5[j]=boot_results[5]
  mse_boot13[j]=(boot1[j]-true_beta[1])^2
  mse_boot23[j]=(boot2[j]-true_beta[2])^2
  mse_boot33[j]=(boot3[j]-true_beta[3])^2
  mse_boot43[j]=(boot4[j]-true_beta[4])^2
  mse_boot53[j]=(boot5[j]-true_beta[5])^2
  #Jackknife的估计
   jack_results <- jackknife_regression(sample_data, n)
   jack1[j]=jack_results[1]
   jack2[j]=jack_results[2]
   ...
   jack4[j]=jack_results[4]
   jack5[j]=jack_results[5]
   mse_jack13[j]=(jack1[j]-true_beta[1])^2
   mse_jack23[j]=(jack2[j]-true_beta[2])^2
   mse_jack33[j]=(jack3[j]-true_beta[3])^2
   mse_jack43[j]=(jack4[j]-true_beta[4])^2
   mse_jack53[j]=(jack5[j]-true_beta[5])^2
}
 #保存参数结果
 results <- rbind(results, data.frame(SampleSize = n, Method = "Bootstrap",Intercept =mean(boot1),X1=mean(boot2),X2=mean(boot3),X3=mean(boot4,na.rm=TRUE),X4=mean(boot5)))
...
ggplot(results1, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[1], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of intercept,  n=40",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results2, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[2], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x1,  n=40",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results3, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[3], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x2, n=40",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results4, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[4], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x3,  n=40",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results5, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[5], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x4,  n=40",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
for(j in 1:K){
  ...
  boot4[j]=boot_results[4]
  boot5[j]=boot_results[5]
  mse_boot14[j]=(boot1[j]-true_beta[1])^2
  mse_boot24[j]=(boot2[j]-true_beta[2])^2
  mse_boot34[j]=(boot3[j]-true_beta[3])^2
  mse_boot44[j]=(boot4[j]-true_beta[4])^2
  mse_boot54[j]=(boot5[j]-true_beta[5])^2
  #Jackknife的估计
   jack_results <- jackknife_regression(sample_data, n)
   jack1[j]=jack_results[1]
   jack2[j]=jack_results[2]
   ...
   jack4[j]=jack_results[4]
   jack5[j]=jack_results[5]
   mse_jack14[j]=(jack1[j]-true_beta[1])^2
   mse_jack24[j]=(jack2[j]-true_beta[2])^2
   mse_jack34[j]=(jack3[j]-true_beta[3])^2
   mse_jack44[j]=(jack4[j]-true_beta[4])^2
   mse_jack54[j]=(jack5[j]-true_beta[5])^2
}
 #保存参数结果
 results <- rbind(results, data.frame(SampleSize = n, Method = "Bootstrap",Intercept =mean(boot1),X1=mean(boot2),X2=mean(boot3),X3=mean(boot4,na.rm=TRUE),X4=mean(boot5)))
...
ggplot(results1, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[1], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of intercept,  n=50",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results2, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[2], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x1  n=50",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results3, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[3], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x2,  n=50",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results4, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[4], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x3,  n=50",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results5, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[5], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x4,  n=50",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
for(j in 1:K){
  ...
  boot4[j]=boot_results[4]
  boot5[j]=boot_results[5]
  mse_boot15[j]=(boot1[j]-true_beta[1])^2
  mse_boot25[j]=(boot2[j]-true_beta[2])^2
  mse_boot35[j]=(boot3[j]-true_beta[3])^2
  mse_boot45[j]=(boot4[j]-true_beta[4])^2
  mse_boot55[j]=(boot5[j]-true_beta[5])^2
  #Jackknife的估计
   jack_results <- jackknife_regression(sample_data, n)
   jack1[j]=jack_results[1]
   jack2[j]=jack_results[2]
   ...
   jack4[j]=jack_results[4]
   jack5[j]=jack_results[5]
   mse_jack15[j]=(jack1[j]-true_beta[1])^2
   mse_jack25[j]=(jack2[j]-true_beta[2])^2
   mse_jack35[j]=(jack3[j]-true_beta[3])^2
   mse_jack45[j]=(jack4[j]-true_beta[4])^2
   mse_jack55[j]=(jack5[j]-true_beta[5])^2
}
 #保存参数结果
 results <- rbind(results, data.frame(SampleSize = n, Method = "Bootstrap",Intercept =mean(boot1),X1=mean(boot2),X2=mean(boot3),X3=mean(boot4,na.rm=TRUE),X4=mean(boot5)))
...
ggplot(results1, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[1], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of intercept, n=62",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results2, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[2], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x1,  n=62",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results3, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[3], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x2,  n=62",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results4, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[4], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x3,  n=62",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(results5, aes(x = Estimate, fill = Method)) +
  ...
  geom_vline(xintercept = true_beta[5], linetype = "solid", color = "red", size = 1) +
  facet_wrap(~ Parameter, scales = "free") +
  labs(title = "Density Plots of x4,  n=62",
       x = "Estimate",
       y = "Density") +
  theme(axis.text = element_text(size = 12),plot.title = element_text(hjust = 0.5, size = 16, face = "bold"))+  # 标题居中并加粗
  theme_minimal()+
...
ggplot(bias_data_long, aes(x = SampleSize, y = Bias, color = Method, group = interaction(Method, Variable))) +
  ...
  labs(title = "Bias of Regression Coefficients (Bootstrap vs Jackknife)", 
       x = "Sample Size", 
       y = "Bias") +
  theme_minimal() +
...
ggplot(mse_data1, aes(x = size, y = MSE, fill = Method)) +
  ...
  labs(title = "MSE of Intercept by Method",
       x = "Size",
...
ggplot(mse_data2, aes(x = size, y = MSE, fill = Method)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "MSE of X1 by Method",
       x = "Size",
       y = "Mean Squared Error (MSE)") +
  theme_minimal() +
  scale_fill_manual(values = c("Bootstrap" = "#42BCB2", "Jackknife" = "#235689")) +
...
ggplot(mse_data3, aes(x = size, y = MSE, fill = Method)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "MSE of X2 by Method",
       x = "Size",
       y = "Mean Squared Error (MSE)") +
  theme_minimal() +
  scale_fill_manual(values = c("Bootstrap" = "#42BCB2", "Jackknife" = "#235689")) +
...
mse_data4 <- data.frame(
  size = rep(c("n_20", "n_30", "n_40", "n_50", "n_62"), 2),
  MSE = c(mean(mse_boot4), mean(mse_jack4)),
  Method = rep(c("Bootstrap", "Jackknife"))
)
...
ggplot(mse_data4, aes(x = size, y = MSE, fill = Method)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "MSE of X3 by Method",
       x = "Size",
       y = "Mean Squared Error (MSE)") +
  theme_minimal() +
  scale_fill_manual(values = c("Bootstrap" = "#42BCB2", "Jackknife" = "#235689")) +
...
ggplot(mse_data5, aes(x = size, y = MSE, fill = Method)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "MSE of X4 by Method",
       x = "Size",
       y = "Mean Squared Error (MSE)") +
  theme_minimal() +
  scale_fill_manual(values = c("Bootstrap" = "#42BCB2", "Jackknife" = "#235689")) +
